...
import { 
  ...
  Clock, Activity, MemoryStick, Cpu, Home
} from 'lucide-react';
...
`);
  ...
  const [activeTab, setActiveTab] = useState<'output' | 'tests' | 'performance'>('output');
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          {result.execution_time && (
                            <span className="text-xs text-gray-400">{result.execution_time}ms</span>
                          )}
                        </div>
                        {result.message && (
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
                      ...
                      <div className="text-2xl font-bold text-white">
                        {performanceMetrics.execution_time.toFixed(3)}s
                      </div>
                    </div>

                    <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
                      <div className="flex items-center mb-2">
                        <MemoryStick className="w-4 h-4 text-purple-400 mr-2" />
                        <span className="text-sm text-gray-400">Memory Usage</span>
                      </div>
                      <div className="text-2xl font-bold text-white">
                        {performanceMetrics.memory_usage.toFixed(2)} MB
                      </div>
                    </div>
